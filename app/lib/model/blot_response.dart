...
class BlotResponseDetails{
  final String message;
  final int status;
  final BlotDetatails data;
  const BlotResponseDetails(
      {required this.message, required this.status, required this.data});

  //factory BlotResponse fromJson
  factory BlotResponseDetails.fromJson(Map<String, dynamic> json) => BlotResponseDetails(
        message: json['message'],
        status: json['status'],
        data: BlotDetatails.fromJson(json['data']),
      );
